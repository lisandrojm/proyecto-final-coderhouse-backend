...
const { swaggerUi, specs, options } = require('./utils/swagger/swagger'); // Importing options here
...
class Server {
  ...
  middlewares() {
    ...
    this.app.use('/api-docs', swaggerUi.serve, swaggerUi.setup(specs, options)); // Using options here
