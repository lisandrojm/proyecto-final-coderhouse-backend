...
- Mailing - Nodemailer - Envío de mails a los usuarios luego de determinadas acciones.
- Mocking y manejo de errores - Faker - Creación de productios ficticios y customizador de errores basico y un diccionario para los errores más comunes al crear un producto.
- Logger - Winston.
- Test - Mocha + Chai + Supertest - Testing unitario en modo introductorio para algunas funcionalidades.
